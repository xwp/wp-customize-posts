...
function wp_customize_posts_init() {
	...
	require_once( plugin_dir_path( __FILE__ ) . '/php/class-wp-customize-posts.php' );
	require_once( plugin_dir_path( __FILE__ ) . '/php/class-wp-post-selector-customize-control.php' );
